...
public class SpringSecurityConfiguration {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // FIX: Using allowedOriginPatterns with "*" allows any origin (like 127.0.0.1 or localhost) 
        // while still permitting credentials (cookies, auth headers). This fixes 403 CORS issues!
